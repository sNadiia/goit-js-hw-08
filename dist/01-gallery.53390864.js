...
const renderGallery = (imgs)=>imgs.reduce((acc, { preview , original , description  })=>acc + `<li class="gallery__item">
...
insertRenderGallery(renderGallery((0, _galleryItems.galleryItems)));
